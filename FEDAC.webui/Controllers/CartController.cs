...
namespace FEDAC.webui.Controllers
{
    ...
    public class CartController:Controller
    {
        ...
        order.OrderNumber = new Random().Next(11111,999999).ToString();
        ...
        order.OrderItems = new List<entity.OrderItem>();
            ...
            foreach(var item in model.CartModel.Cart_items)
            {
                var orderItem = new FEDAC.entity.OrderItem()
                {
                    Price = item.Price,
        ...
        private Payment PaymentProcess(OrderModel model)
        {
            ...
            options.ApiKey = "sandbox-qnh8ZkvtJdFgJhH3mFvrKsADY9eQdKr3";
            options.SecretKey = "sandbox-Ga8wFs0oxpGXeeT6HRgZC6tPTBHm0tbR";
